 ...
 *
 */
public class DatagridControllerClass extends CreateClass {


	public DatagridControllerClass(EventInfo eventinfo) {
		super(eventinfo);
	}
	...
	public void writeClass(String outDir, String currentpath) throws IOException {
		...
		if (!"".equals(eventinfo.getEventName())) {
			String filePath = dirPath + File.separator + eventinfo.getEventName()+ CONTROLLER_FIX+ JAVA_EXT;

			String templateFile = currentpath + TEMPLATE_FOLDER + "Controller" + DAT_EXT;
	...
	protected String getPackage() {
		return PACKAGE_NAME + eventinfo.getDomain() + ".controller";
	}
