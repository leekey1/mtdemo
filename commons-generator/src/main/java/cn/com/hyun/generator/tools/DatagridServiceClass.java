 ...
 *
 */
public class DatagridServiceClass extends CreateClass {


	public DatagridServiceClass(EventInfo eventinfo) {
		super(eventinfo);
	}
	...
	public void writeClass(String outDir, String currentpath) throws IOException {
		...
		if (!"".equals(eventinfo.getEventName())) {
			String filePath = dirPath + File.separator + eventinfo.getEventName()+ SERVICE_FIX+ JAVA_EXT;

			String templateFile = currentpath + TEMPLATE_FOLDER + "Service" + DAT_EXT;
	...
	protected String getPackage() {
		return PACKAGE_NAME + eventinfo.getDomain() + ".service";
	}
