 ...
 *
 */
public class DatagridValidatorClass extends CreateClass {


	public DatagridValidatorClass(EventInfo eventinfo) {
		super(eventinfo);
	}
	...
	public void writeClass(String outDir, String currentpath) throws IOException {
		...
		if (!"".equals(eventinfo.getEventName())) {
			String filePath = dirPath + File.separator + eventinfo.getEventName()+"Validator" + JAVA_EXT;

			String templateFile = currentpath + TEMPLATE_FOLDER + "Validator" + DAT_EXT;
	...
	protected String getPackage() {
		return PACKAGE_NAME + eventinfo.getDomain() + ".validator";
	}
